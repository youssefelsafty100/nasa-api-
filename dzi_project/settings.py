"""
Django settings for dzi_project project.
"""

from pathlib import Path
import os # <<< تمت إضافته لتحديد المسارات بشكل أفضل
...
WSGI_APPLICATION = 'dzi_project.wsgi.application'
